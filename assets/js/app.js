...
FP.SCAN_PROMPT = [
  ...
  "- CAS PARTICULIER FPS (Forfait de Post-Stationnement = 'Avis de paiement / Forfait de post-stationnement (FPS)', amende de stationnement) : le numero est sur la ligne 'Numero de l avis de paiement' sous la forme [longue reference 14 chiffres en bloc] [numero d avis en cases groupees NN N NNN NNN NNN] [Cle 2 chiffres]. Ex : '21590350100017  26 1 163 072 245  Cle 37'. Pour numeroAvis, prends UNIQUEMENT le bloc en cases groupees -> '26 1 163 072 245' (PAS le long prefixe '21590350100017', PAS la Cle). Mets la Cle ('37') dans le champ cle. Pour un FPS : motif = 'Stationnement', points = 0 (un FPS ne retire jamais de point), et montant = 'Le montant du FPS du est egal a : XX euros'.",
