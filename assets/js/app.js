...
FP.SCAN_PROMPT = [
  ...
  "- leasing : facture d un organisme de credit-bail / location longue duree (ex BPCE CAR LEASE, ARVAL, ALD, LEASEPLAN) avec 'Loyer', 'Redevance', 'Services', 'Location', ou une 'Periode' mensuelle de location du vehicule.",
  "- entretien : operations PERIODIQUES ou PREVENTIVES (planifiees ou kilometriques) : revision constructeur, vidange, filtres (habitacle, air, huile, carburant), liquides (refroidissement, frein), bougies, courroie/kit de distribution a l entretien, balais d essuie-glace, pneumatiques d usure, geometrie/parallelisme, recharge de climatisation, presentation au controle technique.",
  "- reparation : suite a une PANNE, un diagnostic de dysfonctionnement ou une piece DEFECTUEUSE : voyant moteur allume, recherche de panne, remise en etat de faisceau, bloc optique/phare, batterie de demarrage HS, contacteur, demarreur, alternateur, embrayage, organes de suspension/direction (biellettes, rotules, amortisseurs), plaquettes/disques suite a usure anormale.",
  "- sinistre : reparations CONSECUTIVES A UN ACCIDENT ou prises en charge par l assurance : bris de glace, franchise, carrosserie apres choc, expertise, remplacement de pare-brise.",
  ...
  "- autre : frais annexes HORS mecanique et HORS detention directe : debours contravention (amende refacturee), demarches administratives (changement d adresse sur carte grise), location ponctuelle d un utilitaire (ex location camion 20m3), fournitures diverses.",
  "En cas de doute entre entretien et reparation : operation planifiee/kilometrique -> entretien ; depannage/remplacement d une piece tombee en panne -> reparation. Choisis TOUJOURS un type ; si vraiment indeterminable, mets 'autre' (jamais null pour une facture).",
