...
FP.SCAN_PROMPT = [
  ...
  "- points : nombre de points retires (entier). Bareme : exces de vitesse < 20 km/h = 1, 20 a 29 = 2, 30 a 39 = 3, 40 a 49 = 4, 50 et plus = 6 ; telephone tenu en main = 3 ; feu rouge = 4 ; stop non respecte = 4 ; ceinture non attachee = 3 ; distance de securite = 3 ; sens interdit = 4 ; stationnement / voie de bus / voie reservee = 0. Si le motif n est pas clair, mets null (ne devine pas).",
  "- vitesseRetenue : pour un exces de vitesse, la vitesse RETENUE en km/h (apres marge technique) ; vitesseLimite : la vitesse maximale autorisee en km/h. Ex : 'controle par un radar a la vitesse de 96 km/h, pour une vitesse limite autorisee de 90 km/h' -> vitesseRetenue 96, vitesseLimite 90. Mets des nombres (sans 'km/h').",
